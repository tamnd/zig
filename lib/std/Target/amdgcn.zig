...
pub const Feature = enum {
    ...
    requires_cov6,
    requires_initial_unclause_vmem,
    restricted_soffset,
    s_barrier_leave_imm,
    s_memrealtime,
    s_memtime_inst,
    ...
    swmmac_gfx1250_insts,
    tanh_insts,
    tensor_cvt_lut_insts,
    tgsplit_support,
    trans_coexecution_hazard,
    ...
    vop3_literal,
    vop3p,
    vop3px2_increments_va_vdst_twice,
    vopd,
    vscnt,
    wait_xcnt,
...
pub const all_features = blk: {
    ...
    result[@backingInt(Feature.@"1536_physical_vgprs")] = .{
        .llvm_name = "1536-physical-vgprs",
        .description = "Has 1536 physical VGPRs per SIMD",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.asynccnt)] = .{
        .llvm_name = "asynccnt",
        .description = "Has separate asynccnt counter",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.dpp_row_bcast)] = .{
        .llvm_name = "dpp-row-bcast",
        .description = "Support DPP row_bcast15/row_bcast31",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.dpp_wavefront_shifts)] = .{
        .llvm_name = "dpp-wavefront-shifts",
        .description = "Support DPP wave_shl/wave_rol/wave_shr/wave_ror",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.dx10_clamp_and_ieee_mode)] = .{
        .llvm_name = "dx10-clamp-and-ieee-mode",
        .description = "Target has DX10_CLAMP and IEEE_MODE kernel descriptor bits",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.flat_offset_bits_12)] = .{
        .llvm_name = "flat-offset-bits-12",
        .description = "Number of bits for flat offset encoding",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.flat_offset_bits_24)] = .{
        .llvm_name = "flat-offset-bits-24",
        .description = "Number of bits for flat offset encoding",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.flat_signed_offset)] = .{
        .llvm_name = "flat-signed-offset",
        .description = "Immediate offset of FLAT instructions are always signed",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.formatted_mubuf_insts)] = .{
        .llvm_name = "formatted-mubuf-insts",
        .description = "Has formatted memory untyped buffer instructions.",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.gfx11_7_insts)] = .{
        .llvm_name = "gfx11-7-insts",
        .description = "Additional instructions for GFX11.7",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.gfx1251_gemm_insts)] = .{
        .llvm_name = "gfx1251-gemm-insts",
        .description = "Has additional gfx1251 DGEMM instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.gfx125x_lowest_rate_wmma)] = .{
        .llvm_name = "gfx125x-lowest-rate-wmma",
        .description = "Has the lowest rate wmma in the gfx125x family, mainly for the gfx12-5-generic",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.gfx13)] = .{
        .llvm_name = "gfx13",
        .description = "GFX13 GPU generation",
        .dependencies = featureSet(&[_]Feature{
            .@"16_bit_insts",
            .a16,
            .add_no_carry_insts,
    ...
    result[@backingInt(Feature.gfx13_insts)] = .{
        .llvm_name = "gfx13-insts",
        .description = "Additional instructions for GFX13+",
        .dependencies = featureSet(&[_]Feature{
            .s_barrier_leave_imm,
            .s_wakeup_imm,
        }),
    ...
    result[@backingInt(Feature.ieee_minimum_maximum_insts)] = .{
        ...
        .description = "Has v_minimum/maximum_f16/f32/f64, v_minimummaximum/maximumminimum_f16/f32 andv_pk_minimum/maximum_f16 instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.instcachelinesize128)] = .{
        .llvm_name = "instcachelinesize128",
        .description = "Instruction cache line size in bytes.",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.instcachelinesize64)] = .{
        .llvm_name = "instcachelinesize64",
        .description = "Instruction cache line size in bytes.",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.mad_nc_64_32_insts)] = .{
        .llvm_name = "mad-nc-64-32-insts",
        .description = "Has v_mad_nc_{u64_u32|i64_i32} instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.min_max_i64_insts)] = .{
        .llvm_name = "min-max-i64-insts",
        .description = "Has v_{min|max}_{i|u}64 instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.mqsad_insts)] = .{
        .llvm_name = "mqsad-insts",
        .description = "Has v_mqsad_u32_u8 instruction",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.mqsad_pk_insts)] = .{
        .llvm_name = "mqsad-pk-insts",
        .description = "Has v_mqsad_pk_u16_u8 instruction",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.msad_insts)] = .{
        .llvm_name = "msad-insts",
        .description = "Has v_msad_u8 instruction",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.mtbuf_insts)] = .{
        .llvm_name = "mtbuf-insts",
        .description = "Has memory typed buffer instructions.",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.negative_unaligned_scratch_offset_bug)] = .{
        ...
        .description = "Scratch instructions with a VGPR offset and a negative immediate offset thatis not a multiple of 4 read wrong memory on GFX10",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.no_f16_pseudo_scalar_trans_inline_constants)] = .{
        .llvm_name = "no-f16-pseudo-scalar-trans-inline-constants",
        .description = "Inline constants are not supported for F16 pseudo scalar transcendentals",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.packed_fp64_ops)] = .{
        .llvm_name = "packed-fp64-ops",
        .description = "Support packed fp64 instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.packed_u64_ops)] = .{
        .llvm_name = "packed-u64-ops",
        .description = "Support packed uint64 instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.permlane16_insts)] = .{
        .llvm_name = "permlane16-insts",
        .description = "Has v_permlane16_b32/v_permlanex16_b32 instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.requires_initial_unclause_vmem)] = .{
        .llvm_name = "requires-initial-unclause-vmem",
        .description = "Hardware entrypoints require first VMEM instruction to be unclaused",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.s_barrier_leave_imm)] = .{
        .llvm_name = "s-barrier-leave-imm",
        .description = "s_barrier_leave takes an immediate operand",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.s_wakeup_imm)] = .{
        .llvm_name = "s-wakeup-imm",
        .description = "s_wakeup takes an immediate operand",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.salu_minimum_maximum_insts)] = .{
        .llvm_name = "salu-minimum-maximum-insts",
        .description = "Has s_minimum/maximum_f16/f32 instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.smem_prefetch_insts)] = .{
        .llvm_name = "smem-prefetch-insts",
        .description = "Has s_prefetch_inst, s_prefetch_inst_pc_rel, s_prefetch_data and s_prefetch_data_pc_rel instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.swmmac_gfx1200_insts)] = .{
        .llvm_name = "swmmac-gfx1200-insts",
        .description = "Has GFX1200 SWMMAC instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.swmmac_gfx1250_insts)] = .{
        .llvm_name = "swmmac-gfx1250-insts",
        .description = "Has GFX1250 SWMMAC instructions",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.tgsplit_support)] = .{
        .llvm_name = "tgsplit-support",
        .description = "Hardware support for threadgroup split execution mode",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.trans_coexecution_hazard)] = .{
        .llvm_name = "trans-coexecution-hazard",
        .description = "Hazard when TRANS co-executes with other VALU instruction",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.use_add_pc64_inst)] = .{
        .llvm_name = "use-add-pc64-inst",
        .description = "Use s_add_pc_i64 instruction.",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.v_mov_b64_inst)] = .{
        .llvm_name = "v-mov-b64-inst",
        .description = "Has v_mov_b64 instruction",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.v_mul_u64_inst)] = .{
        .llvm_name = "v-mul-u64-inst",
        .description = "Has v_mul_u64 instruction.",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.vmem_to_lds_load_insts)] = .{
        ...
        .description = "The platform has memory to lds instructions (global_load w/lds bit set, buffer_loadw/lds bit set or global_load_lds. This does not include scratch_load_lds.",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.vop3px2_increments_va_vdst_twice)] = .{
        .llvm_name = "vop3px2-increments-va-vdst-twice",
        .description = "VOP3PX2 encoded instructions increment the VaVdst counter twice",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.wmma_128b_insts)] = .{
        .llvm_name = "wmma-128b-insts",
        .description = "Has WMMA instructions where A and B matrices do not have duplicated data",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.wmma_256b_insts)] = .{
        .llvm_name = "wmma-256b-insts",
        .description = "Has WMMA instructions where A and B matrices have duplicated data",
        .dependencies = featureSet(&[_]Feature{}),
    };
    result[@backingInt(Feature.wmma_coexecution_hazards)] = .{
        .llvm_name = "wmma-coexecution-hazards",
        .description = "Hazards when WMMA co-executes with other WMMA/VALU instruction",
        .dependencies = featureSet(&[_]Feature{}),
    };
    ...
    result[@backingInt(Feature.xnack_on_off_modes)] = .{
        .llvm_name = "xnack-on-off-modes",
        .description = "Target supports XNACK on/off modes",
        .dependencies = featureSet(&[_]Feature{
            .xnack_support,
        }),
    };
...
pub const cpu = struct {
    ...
    pub const gfx11_7_generic: CpuModel = .{
        .name = "gfx11_7_generic",
        .llvm_name = "gfx11-7-generic",
        .features = featureSet(&[_]Feature{
            .architected_flat_scratch,
            .atomic_fadd_no_rtn_insts,
            .atomic_fadd_rtn_insts,
    ...
    pub const gfx12_5_generic: CpuModel = .{
        .name = "gfx12_5_generic",
        .llvm_name = "gfx12-5-generic",
        .features = featureSet(&[_]Feature{
            .@"1024_addressable_vgprs",
            .@"45_bit_num_records_buffer_resource",
            .@"64_bit_literals",
    ...
    pub const gfx13_generic: CpuModel = .{
        .name = "gfx13_generic",
        .llvm_name = "gfx13-generic",
        .features = featureSet(&[_]Feature{
            .@"1536_physical_vgprs",
            .@"64_bit_literals",
            .addressablelocalmemorysize65536,
